  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_PYTHON_API_URL}/subscribe-newsletter`,
        {
          method: "POST",
          headers: {
      ...
      if (response.ok && responseData.success) {
        ...
        toast({
          title: "Success!",
          description:
            responseData.message || "You've been subscribed to our newsletter",
        });
      } else {
      ...
      >
        <div className="relative">
          <Input
            ...
            className={`bg-white border-gray-300 ${
              errors.firstName ? "border-state-error" : ""
            }`}
        ...
        <div className="relative">
          <Input
            ...
            className={`bg-white border-gray-300 ${
              errors.lastName ? "border-state-error" : ""
            }`}
            disabled={isSubmitting}
            {...register("lastName", {
