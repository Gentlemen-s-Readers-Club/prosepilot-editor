                ...
                <div className="bg-state-success-light border border-state-success rounded-lg p-6 mt-8">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 text-sm">
                      ...
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">Ctrl+Y</span>
                        <span className="text-base-paragraph ml-3">Redo</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">Ctrl+A</span>
                        <span className="text-base-paragraph ml-3">Select all</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">Ctrl+C</span>
                        <span className="text-base-paragraph ml-3">Copy</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">Ctrl+V</span>
                        <span className="text-base-paragraph ml-3">Paste</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">Ctrl+X</span>
                        <span className="text-base-paragraph ml-3">Cut</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">Ctrl+F</span>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 text-sm">
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">⌘+B</span>
                        <span className="text-base-paragraph ml-3">Bold text</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">⌘+I</span>
                        <span className="text-base-paragraph ml-3">Italic text</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">⌘+Z</span>
                        <span className="text-base-paragraph ml-3">Undo</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">⌘+Shift+Z</span>
                        <span className="text-base-paragraph ml-3">Redo</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">⌘+A</span>
                        <span className="text-base-paragraph ml-3">Select all</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">⌘+C</span>
                        <span className="text-base-paragraph ml-3">Copy</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">⌘+V</span>
                        <span className="text-base-paragraph ml-3">Paste</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">⌘+X</span>
                        <span className="text-base-paragraph ml-3">Cut</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
                        <span className="font-medium text-base-heading">⌘+F</span>
                        <span className="text-base-paragraph ml-3">Find</span>
                      </div>
                      <div className="bg-white p-3 rounded-md">
