        ...
        <div>
          ...
          <div className="bg-state-info-light border border-state-info rounded-lg p-6 mb-8">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold text-state-info mb-2">About This Policy</h3>
          ...
          <section id="information-we-collect" className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-state-success-light border border-state-success rounded-lg p-6">
                <h3 className="text-lg font-semibold text-state-success mb-3">AI-Generated Content</h3>
          ...
          <section id="sharing-information" className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-state-warning-light border border-state-warning rounded-lg p-6">
                <h3 className="text-lg font-semibold text-state-warning mb-3">Third-Party Services</h3>
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm text-state-warning mt-2">
          ...
          <section id="cookies" className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-state-info-light border border-state-info rounded-lg p-6">
                <h3 className="text-lg font-semibold text-state-info mb-3">Do Not Track</h3>
                <p className="text-state-info text-sm">
          ...
          <section id="data-security" className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-state-warning-light border border-state-warning rounded-lg p-6">
                <h3 className="text-lg font-semibold text-state-warning mb-3">Your Responsibility</h3>
                <p className="text-state-warning text-sm">
          ...
          <section id="your-rights" className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-state-info-light border border-state-info rounded-lg p-6">
                <h3 className="text-lg font-semibold text-state-info mb-3">For EU/EEA Residents</h3>
                <p className="text-state-info text-sm">
              ...
              <div className="bg-state-success-light border border-state-success rounded-lg p-6">
                <h3 className="text-lg font-semibold text-state-success mb-3">For California Residents</h3>
                <p className="text-state-success text-sm">
