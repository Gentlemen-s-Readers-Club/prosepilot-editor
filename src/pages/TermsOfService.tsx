...
export function TermsOfService() {
  ...
  return (
    <>
      <SEOHead
        title="Terms of Service - ProsePilot"
        description="Read ProsePilot's Terms of Service. Learn about our AI writing platform policies, user rights, content ownership, subscription terms, and legal agreements."
        keywords="ProsePilot terms of service, user agreement, legal terms, AI writing terms, platform policies"
        type="article"
      />
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-base-paragraph text-sm">
                        Email:{" "}
                        <a
                          href="mailto:support@prosepilot.app"
                          className="text-brand-primary hover:underline"
                        >
