/*
  ...
  1. New Tables
    - `teams` - Core team information with logo, description, and settings
    - `team_members` - Member roles and status management  
    - `team_invitations` - Email-based invitation system with expiration
    - `team_activity_logs` - Complete audit trail of all team actions

  2. Enhanced Tables
    - `books` - Add team_id for collaborative books

  3. Security
    - Enable RLS on all new tables
    - Add comprehensive policies for role-based access
    - Update existing book/chapter policies for team access
