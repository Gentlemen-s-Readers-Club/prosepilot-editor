/*
  ...
  1. Foreign Key Constraints
    - Add missing foreign key constraint for team_activity_logs.user_id -> profiles.id
    - Add missing foreign key constraint for team_invitations.invited_by -> profiles.id
    
  2. RPC Function
    - Create get_team_stats function to return team statistics
...
-- Create or replace the get_team_stats function
...
-- Create accept_team_invitation function if it doesn't exist
