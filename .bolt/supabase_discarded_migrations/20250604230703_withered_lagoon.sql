/*
  ...
  2. Implementation
    - Use temporary column to avoid NULL constraint issues
    - Update all languages with proper HTML language codes
    - Add final NOT NULL constraint after data is populated
*/
